package de.jonesir.zentraleeinrichtungen;
...
public class ZentraleeinrichtungenFragment extends BaseFragment {

	public ZentraleeinrichtungenFragment(Context context) {
		super(context);
	}
